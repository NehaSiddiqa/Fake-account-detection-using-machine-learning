...
main = Tk()
main.title("Machine Learning Techniques for fake account identification")
...
font = ('times', 15, 'bold')
title = Label(main, text='Machine Learning Techniques for fake account identification')
